    ...
    <div className="p-5 rounded-md shadow-xl bg-white border  border-gray-100">
      ...
      <div>
        ...
        <p className=" text-sm text-gray-600">
          ...
          aliquam numquam provident esse reprehenderit aliquid nostrum quisquam
          laboriosam ipsa! Placeat!
        </p>
      </div>
      <div>
      ...
      <div className="flex items-center gap-4 mt-4">
        <Button onClick ={() => navigate(`/description/${jobId}`)} varaint ="outline">Details</Button>
