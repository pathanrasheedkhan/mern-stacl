...
import { APPLICATION_API_END_POINT, JOB_API_END_POINT } from "@/utils/content";
...
//         onClick = {isApplied ? null : applyJobHandler}
//         disabled={isApplied} 
//         className = {`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed text-white rounded-full ' : 'bg-[#7209b7] text-white rounded-full hover:bg-[#31195a]'}`}>{ isApplied ? 'Applied' : 'Apply'}
...
// http://localhost:8000/application/apply/66aa07abbbb14b4eac50f1d6 